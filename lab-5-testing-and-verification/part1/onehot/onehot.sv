...
(* hdlname = "onehot" *)
(* src = "onehot.soln.sv:1.8-1.14" *)
module onehot(a_i, b_i, c_i, d_i, e_o);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire _058_;
  wire _059_;
  (* src = "onehot.soln.sv:2.10-2.13" *)
  input a_i;
  wire a_i;
  (* src = "onehot.soln.sv:3.10-3.13" *)
  input b_i;
  wire b_i;
  (* src = "onehot.soln.sv:4.10-4.13" *)
  input c_i;
  wire c_i;
  (* src = "onehot.soln.sv:10.15-10.23" *)
  wire [3:0] concat_w;
  (* src = "onehot.soln.sv:5.10-5.13" *)
  input d_i;
  wire d_i;
  (* src = "onehot.soln.sv:7.11-7.14" *)
  output e_o;
  wire e_o;
  assign _007_ = ~a_i;
  assign _011_ = c_i & d_i;
  ...
  assign _058_ = ~_003_;
  assign _059_ = ~_006_;
  assign concat_w = { a_i, b_i, c_i, d_i };
  assign _008_ = _034_;
  assign _009_ = _016_;
  assign _010_ = _019_;
  assign _000_ = _020_;
