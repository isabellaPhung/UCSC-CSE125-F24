...
module priority_enc(enc_o, vec_i);
  ...
  assign { \bsg.i [7], \bsg.i [5], \bsg.i [3], \bsg.i [1] } = { \bsg.addr[1] [6], \bsg.addr[1] [4], \bsg.addr[1] [2], \bsg.addr[1] [0] };
  assign \bsg.rof[1].rof1[0].vs  = { \bsg.addr[1] [0], \bsg.i [0] };
  assign \bsg.rof[1].rof1[1].vs  = { \bsg.addr[1] [2], \bsg.i [2] };
  assign \bsg.rof[1].rof1[2].vs  = { \bsg.addr[1] [4], \bsg.i [4] };
  assign \bsg.rof[1].rof1[3].vs  = { \bsg.addr[1] [6], \bsg.i [6] };
  ...
  assign \bsg.v[0]  = { \bsg.addr[1] [6], \bsg.i [6], \bsg.addr[1] [4], \bsg.i [4], \bsg.addr[1] [2], \bsg.i [2], \bsg.addr[1] [0], \bsg.i [0] };
